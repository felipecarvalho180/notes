...
export function NoteCard({
  ...
  return (
    <Dialog.Root>
      <Dialog.Trigger className="text-left bg-slate-800 rounded-md p-5 space-y-3 overflow-hidden relative hover:ring-2 hover:ring-slate-600 focus-visible:ring-2 focus-visible:ring-lime-400 outline-none flex flex-col">
